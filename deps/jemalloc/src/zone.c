...
typedef struct malloc_introspection_t {
  kern_return_t (*enumerator)(task_t, void *, unsigned, vm_address_t, memory_reader_t,
                              vm_range_recorder_t);
...
static unsigned zone_batch_malloc(struct _malloc_zone_t *zone, size_t size, void **results,
                                  unsigned num_requested);
static void zone_batch_free(struct _malloc_zone_t *zone, void **to_be_freed,
...
static void *zone_malloc(malloc_zone_t *zone, size_t size) { return je_malloc(size); }
...
static size_t zone_pressure_relief(struct _malloc_zone_t *zone, size_t goal) { return 0; }
