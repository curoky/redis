...
#define MUTEX_PROF_UINT32_COUNTERS OP(max_num_thds, uint32_t, "max_n_thds")
...
#define COUNTER_ENUM(counter_list, t) \
  typedef enum { counter_list mutex_prof_num_##t##_counters } mutex_prof_##t##_counter_ind_t;
