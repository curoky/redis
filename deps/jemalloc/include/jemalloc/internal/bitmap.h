...
#define BITMAP_GROUPS_L3(nbits) \
  BITMAP_BITS2GROUPS(BITMAP_BITS2GROUPS(BITMAP_BITS2GROUPS(BITMAP_BITS2GROUPS((nbits)))))
  ...
  {                                                                                        \
    ...
    nbits, /* nlevels. */                                                                  \
        (BITMAP_GROUPS_L0(nbits) > BITMAP_GROUPS_L1(nbits)) +                              \
            ...
            (BITMAP_GROUPS_L3(nbits) > BITMAP_GROUPS_L4(nbits)) + 1, /* levels. */         \
    {                                                                                      \
      {0}, {BITMAP_GROUPS_L0(nbits)}, {BITMAP_GROUPS_L1(nbits) + BITMAP_GROUPS_L0(nbits)}, \
          {BITMAP_GROUPS_L2(nbits) + BITMAP_GROUPS_L1(nbits) + BITMAP_GROUPS_L0(nbits)},   \
...
static inline size_t bitmap_ffu(const bitmap_t *bitmap, const bitmap_info_t *binfo,
                                size_t min_bit) {
  ...
  for (unsigned level = binfo->nlevels; level--;) {
    ...
    unsigned group_nmask = (unsigned)(((min_bit > bit) ? (min_bit - bit) : 0) >>
