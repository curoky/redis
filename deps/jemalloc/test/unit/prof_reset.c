...
static size_t get_lg_prof_sample(void) {
  ...
  assert_d_eq(mallctl("prof.lg_sample", (void *)&lg_prof_sample, &sz, NULL, 0), 0,
              "Unexpected mallctl failure while reading profiling sample rate");
  return lg_prof_sample;
}

static void do_prof_reset(size_t lg_prof_sample) {
  assert_d_eq(mallctl("prof.reset", NULL, NULL, (void *)&lg_prof_sample, sizeof(size_t)), 0,
...
TEST_BEGIN(test_prof_reset_basic) {
  ...
  sz = sizeof(size_t);
  assert_d_eq(mallctl("opt.lg_prof_sample", (void *)&lg_prof_sample_orig, &sz, NULL, 0), 0,
              "Unexpected mallctl failure while reading profiling sample rate");
...
static bool prof_dump_header_intercept(tsdn_t *tsdn, bool propagate_err,
...
TEST_BEGIN(test_prof_reset_cleanup) {
  ...
  assert_d_eq(mallctl("prof.dump", NULL, NULL, NULL, 0), 0,
...
int main(void) {
  ...
  return test_no_reentrancy(test_prof_reset_basic, test_prof_reset_cleanup, test_prof_reset,
                            test_xallocx);
}
