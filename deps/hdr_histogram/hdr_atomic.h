...
static bool __inline hdr_atomic_compare_exchange_64(volatile int64_t* field, int64_t* expected,
                                                    int64_t desired) {
...
static inline bool hdr_atomic_compare_exchange_64(volatile int64_t* field, int64_t* expected,
                                                  int64_t desired) {
  int64_t original;
